package com.ar_tech.radar_scan_view;
...
public class RadarView extends View {
    ...
    public static int POINT_ARRAY_SIZE = 55;
    ...
    public RadarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        localPaint.setColor(getResources().getColor(R.color.stroke_color));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (showCircles) {
             ...
             */
            canvas.drawLine(i-r, j,i+r , j, localPaint);

            /*
            to draw vertical line
             */
            canvas.drawLine(i, j-r,i , j+r, localPaint);

            /*
            to draw 1st outer circle
             */
            canvas.drawCircle(i, i, j, localPaint);

            /*
            to draw 2nd inner circle
             */
